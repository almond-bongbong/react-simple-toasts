            ...
            <table className={styles.table}>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    A boolean value that determines whether the toast message is clickable. Default
                    is <code>false</code>.
                  </td>
                  <td></td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    The maximum number of toast messages that can be displayed simultaneously.
                    Default is <code>null</code>, which allows an unlimited number of toasts.
                  </td>
                  <td></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    A function to be called when the toast message is clicked. This function takes
                    an <code>event</code> argument, which is the click event. Must be used with{' '}
                ...
                <tr>
                  ...
                  <td>
                    A function to be called when the toast message is closed and the closing
            ...
            <table className={styles.table}>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    Updates the message and duration of the currently displayed toast message.
                  </td>
                  <td>3.5.0</td>
                </tr>
                <tr>
                  ...
                  <td>
                    ...
                    <code>ToastUpdateOptions</code> object. This allows for more granular control
                    over the toast's content and behavior.
                  </td>
                  <td>5.8.0</td>
                </tr>
              </tbody>
            ...
            <table className={styles.table}>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    The new duration (in milliseconds) for which the toast message will be
                    displayed.
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    The new theme to apply to the toast. Must be one of the predefined themes.
                  </td>
                </tr>
              </tbody>
            </table>
